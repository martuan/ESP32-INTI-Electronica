...
//       lineaMedicion = "";
 ...
 /*      presion1PartEntera = int(presion1Anterior);
       presion1Partdecimal = int((presion1Anterior - presion1PartEntera) * 100);
       sprintf(medicion, "%d.%02d", (int)presion1Anterior, presion1Partdecimal);
       lineaMedicion += String(segundos);
       lineaMedicion += ",  ";
       lineaMedicion += String(medicion);
       lineaMedicion += "\r";  */  
       nombreArchivo.remove(16,4);
//       nombreArchivo.remove(14,4);
 ...
 //      writeFile(SD, nombreArchivo.c_str(), "\r\n");
       ...
       appendFile(SD, nombreArchivo.c_str(), lineaMedicionAnterior.c_str());   
...
//    if(valorAD_fuelle < 551){   bajaPresionFuelle = HIGH;}
//    if(valorAD_fuelle > 1082){   altaPresionFuelle = HIGH;}
